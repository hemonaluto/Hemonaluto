...
PLAYER_DESCRIPTION, PLAYER_NAME, ROPE_DESCRIPTION, ROPE_NAME, JESTER_NAME, JESTER_DESCRIPTION
...
player.health = 100
jester = Animate(JESTER_NAME, JESTER_DESCRIPTION)
jester.health = 100
jester.move_function = "move_jester"
...
bedroom.contents.extend([player, jester, bed, bedroom_door, bedroom_hook,
